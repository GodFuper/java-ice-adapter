...
public class OneIceServer {
    ...
    public static Pair<List<OneIceServer>, Set<CoturnServer>> mapperFromMap(List<Map<String, Object>> iceServersData) {
            ...
            if (iceServerData.containsKey("urls")) {
                ...
                urls.stream()
                        ...
                        .forEach(uri -> {
                            ...
                            OneIceServer iceServer = new OneIceServer(type, address);
